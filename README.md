...
Este repositório contém o código-fonte e a documentação do projeto de automação de iluminação para ambientes domésticos, focado em proporcionar conforto e redução de ansiedade via controle inteligente de cor e brilho.
...
- Vídeo demonstrativo: https://www.youtube.com/watch?v=3vfVb3Q4Y-M .
